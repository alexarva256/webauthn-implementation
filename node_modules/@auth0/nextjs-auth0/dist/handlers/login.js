...
function loginHandler(settings, clientProvider) {
    return (req, res, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        state = state_1.createState(Object.assign({ redirectTo: ((_a = req.query) === null || _a === void 0 ? void 0 : _a.redirectTo) || (options === null || options === void 0 ? void 0 : options.redirectTo) }, getLoginState(req))), max_age } = _b, authParams = tslib_1.__rest(_b, ["state", "max_age"]);
        // Create the authorization url.
        const client = yield clientProvider();
        const authorizationUrl = client.authorizationUrl(Object.assign({ redirect_uri: settings.redirectUri, scope: settings.scope, response_type: 'code', audience: settings.audience, state, auth0Client: telemetry(), max_age: max_age === undefined ? max_age : +max_age }, authParams));
